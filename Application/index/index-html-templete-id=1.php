...
<html>
<head>
    <title>小枫Info-Html5+css3情侣博客模板</title>
...
<div class="row">
    ...
    <div class="detail-content">
        <p>
   分享一个企业的单页宣传模板，介绍企业的主要相关信息，产品信息，以及企业的联系方式等。适合只做宣传的公司，页面简单就行。</p>
   <p class="center"><b>首页截图</b></p>
   <hr>
   <div class="center">

<img src="../../assets/images/index-html-templete-img=2.jpg" class="templete-detail-img">
</div>
<br>
<br>
<div class="center">
  <a href="http://www.3dst.cn/" target="_blank"><button type="button" class="btn btn-success" >在线预览</button></a>
  <a href="http://pan.baidu.com/s/1mgiNfU4" target="_blank"><button type="button" class="btn btn-primary" >下载源码</button></a>
</div>
